...
public class NonBlockingHashMap<K, V> extends AbstractMap<K, V> implements ConcurrentMap<K, V>, Cloneable {
    ...
    private static Object get_impl(final NonBlockingHashMap topmap, final Object[] kvs, final Object key, final int fullhash) {
    ...
    static class Counter {
        ...
        private static final AtomicReferenceFieldUpdater<Counter, CAT> _catUpdater =
                AtomicReferenceFieldUpdater.newUpdater(Counter.class, CAT.class, "_cat");
        ...
        static class CAT {
            ...
            // ONCE.
            public long add_if_mask(long x, long mask, int hash, Counter master) {
                long[] t = _t;
