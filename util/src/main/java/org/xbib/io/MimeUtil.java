...
public final class MimeUtil {
    ...
    private static final Map<String, String> mimeTypeToExtensionMap = new LinkedHashMap<String, String>();

    private static final Map<String, String> extensionToMimeTypeMap = new LinkedHashMap<String, String>();
    ...
    static {
        ...
        add("application/marcxml+xml", "marcxml");
        add("application/sru+xml", "sru");

        // WTF
        add("application/mods+html", "modshtml");
    ...
    private static InputStream getContentTypesPropertiesStream() {
        InputStream in = MimeUtil.class.getResourceAsStream("/content-types.properties");
        if (in != null) {
            return in;
        }
     ...
     * @return The extension for the given MIME type or null iff there is none.
     */
    public static String guessExtensionFromMimeType(String mimeType, String defaultExtension) {
        if (mimeType == null || mimeType.isEmpty()) {
            return null;
        }
        if ("*/*".equals(mimeType)) {
