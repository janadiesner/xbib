...
public final class Fun {
    ...
    final static public class Tuple3<A, B, C> implements Comparable, Serializable {
        ...
        public boolean equals(Object o) {
            ...
            if (a != null ? !a.equals(tuple3.a) : tuple3.a != null) {
                return false;
            }
            if (b != null ? !b.equals(tuple3.b) : tuple3.b != null) {
                return false;
            }
            if (c != null ? !c.equals(tuple3.c) : tuple3.c != null) {
                return false;
            }
    ...
    final static public class Tuple4<A, B, C, D> implements Comparable, Serializable {
        ...
        public boolean equals(Object o) {
            ...
            if (a != null ? !a.equals(tuple4.a) : tuple4.a != null) {
                return false;
            }
            if (b != null ? !b.equals(tuple4.b) : tuple4.b != null) {
                return false;
            }
            if (c != null ? !c.equals(tuple4.c) : tuple4.c != null) {
                return false;
            }
            if (d != null ? !d.equals(tuple4.d) : tuple4.d != null) {
                return false;
            }
