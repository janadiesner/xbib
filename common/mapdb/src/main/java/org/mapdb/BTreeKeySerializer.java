...
//            System.out.println(start+" - "+end+" - "+Arrays.toString(keys));
    ...
    public final static class Tuple2KeySerializer<A, B> extends BTreeKeySerializer<Fun.Tuple2<A, B>> implements Serializable {
        ...
        public boolean equals(Object o) {
            ...
            if (aComparator != null ? !aComparator.equals(that.aComparator) : that.aComparator != null) {
                return false;
            }
            if (aSerializer != null ? !aSerializer.equals(that.aSerializer) : that.aSerializer != null) {
                return false;
            }
            if (bSerializer != null ? !bSerializer.equals(that.bSerializer) : that.bSerializer != null) {
                return false;
            }
    ...
    public static class Tuple3KeySerializer<A, B, C> extends BTreeKeySerializer<Fun.Tuple3<A, B, C>> implements Serializable {
        ...
        public boolean equals(Object o) {
            ...
            if (bComparator != null ? !bComparator.equals(that.bComparator) : that.bComparator != null) {
                return false;
            }
            if (bSerializer != null ? !bSerializer.equals(that.bSerializer) : that.bSerializer != null) {
                return false;
            }
            if (cSerializer != null ? !cSerializer.equals(that.cSerializer) : that.cSerializer != null) {
                return false;
            }
    ...
    public static class Tuple4KeySerializer<A, B, C, D> extends BTreeKeySerializer<Fun.Tuple4<A, B, C, D>> implements Serializable {
        ...
        public boolean equals(Object o) {
            ...
            if (cComparator != null ? !cComparator.equals(that.cComparator) : that.cComparator != null) {
                return false;
            }
            if (cSerializer != null ? !cSerializer.equals(that.cSerializer) : that.cSerializer != null) {
                return false;
            }
            if (dSerializer != null ? !dSerializer.equals(that.dSerializer) : that.dSerializer != null) {
                return false;
            }
