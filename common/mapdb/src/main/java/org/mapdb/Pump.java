...
public class Pump {
    ...
    public static <E> Iterator<E> sort(final Iterator<E> source, final int batchSize,
        ...
        try {
            ...
            for (int i = 0; i < presortCount.length; i++) {
                presortCount[i] = presortCount2.get(i);
            }
     ...
     * To sort unordered data use {@link org.mapdb.Pump#sort(java.util.Iterator, int, java.util.Comparator, Serializer)}
     * <p/>
        ...
        while (source.hasNext()) {
            ...
            for (int i = 0; i < nload && source.hasNext(); i++) {
                ...
                if (hasVals) {
                    ...
                    if (val == null) {
                        throw new NullPointerException("valueExtractor returned null value");
                    }
