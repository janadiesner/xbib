...
public class StoreDirectFreeSpaceTest {
    ...
    StoreDirect stub = new StoreDirect(Volume.memoryFactory(false, max, false), false, false, 5, false, max, false, false, null, false) {
        ...
        private Deque<Long> stackList(long ioList) {
            if (longStacks.get(ioList) == null) {
                longStacks.put(ioList, new LinkedList<Long>());
            }
