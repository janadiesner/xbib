...
import static org.mapdb.StoreDirect.LONG_STACK_PREF_SIZE;
import static org.mapdb.StoreDirect.MASK_LINKED;
import static org.mapdb.StoreDirect.MASK_OFFSET;
import static org.mapdb.StoreDirect.MAX_REC_SIZE;
import static org.mapdb.StoreDirect.size2ListIoRecid;
...
public class StoreDirectTest<E extends StoreDirect> extends EngineTest<E> {
    ...
    @Test
    public void second_rec_pos_round_to_16() {
        e.structuralLock.lock();
    ...
    @Test
    public void test_long_stack_puts_record_offset_into_index() throws IOException {
        e.structuralLock.lock();
    ...
    @Test
    public void test_large_long_stack() throws IOException {
        //dirty hack to make sure we have lock
        e.structuralLock.lock();
    ...
    @Test
    public void test_basic_long_stack_no_commit() throws IOException {
        //dirty hack to make sure we have lock
        e.structuralLock.lock();
        final long max = 150;
        for (long i = 1; i < max; i++) {
    ...
    @Test
    public void test_large_long_stack_no_commit() throws IOException {
        //dirty hack to make sure we have lock
        e.structuralLock.lock();
        final long max = 15000;
        for (long i = 1; i < max; i++) {
