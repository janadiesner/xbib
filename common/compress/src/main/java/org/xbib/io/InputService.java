...
public final class InputService {
    ...
    // order is important: first instantiate providers map, then instance
    private final static Map<String, InputStreamProvider> providers = new WeakHashMap();
    ...
    private InputService() {
        ...
        for (InputStreamProvider provider : loader) {
    ...
    public static InputStream getInputStream(URI uri) throws IOException {
        ...
        for (InputStreamProvider provider : providers.values()) {
