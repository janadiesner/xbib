...
public class ReflectiveHelperTest extends AbstractTest {
    ...
    public CharSequence params(final Object context, final long l, final double d, final float f,
        ...
        return StringUtil.join(new Object[]{l, d, f, c, b, s}, ", ");
    }
    ...
    public Handlebars.SafeString helperWithParamsAndOptions(final String context, final boolean p0,
                                                            final int p1,
                                                            final Options options) {
        assertNotNull(options);
        return new Handlebars.SafeString(String.format("helperWithParamsAndOptions:%s:%s:%s", context, p0, p1));
    }
