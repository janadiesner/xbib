...
import static org.xbib.template.handlebars.util.Validate.validIndex;
...
public enum StringHelpers implements Helper<Object> {
    ...
    capitalizeFirst {
        ...
        protected CharSequence safeApply(final Object value, final Options options) {
            return StringUtil.capitalize(value.toString());
        }
    ...
    center {
        ...
        protected CharSequence safeApply(final Object value, final Options options) {
            ...
            return StringUtil.center(value.toString(), size, pad);
        }
    },
    ...
    join {
        ...
        protected CharSequence safeApply(final Object context, final Options options) {
            ...
            if (context instanceof Iterable) {
                return prefix + StringUtil.join((Iterable) context, (String) separator) + suffix;
            }
            if (context instanceof Iterator) {
                return prefix + StringUtil.join((Iterator) context, (String) separator) + suffix;
            }
            if (context.getClass().isArray()) {
                return prefix + StringUtil.join((Object[]) context, (String) separator) + suffix;
            }
            ...
            values[0] = context;
            return prefix + StringUtil.join(values, (String) separator) + suffix;
        }
    },
    ...
    ljust {
        ...
        protected CharSequence safeApply(final Object value, final Options options) {
            ...
            notNull(size, "found 'null', expected 'size'");
            String pad = options.hash("pad", " ");
            return StringUtil.rightPad(value.toString(), size, pad);
        }
    },
    ...
    rjust {
        ...
        protected CharSequence safeApply(final Object value, final Options options) {
            ...
            notNull(size, "found 'null', expected 'size'");
            String pad = options.hash("pad", " ");
            return StringUtil.leftPad(value.toString(), size, pad);
        }
    },
    ...
    slugify {
        @Override
        protected CharSequence safeApply(final Object context, final Options options) {
            String value = StringUtil.strip(context.toString());
    ...
    capitalize {
        ...
        protected CharSequence safeApply(final Object value, final Options options) {
            ...
            return fully
                    ? StringUtil.capitalizeFully(value.toString())
                    : StringUtil.capitalize(value.toString());
        }
    },
    ...
    wordWrap {
        ...
        protected CharSequence safeApply(final Object value, final Options options) {
            ...
            return StringUtil.fixedWidth(value.toString(), length);
        }
