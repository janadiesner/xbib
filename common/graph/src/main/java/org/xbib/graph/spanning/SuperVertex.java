...
import org.xbib.graph.VertexPair;

/**
 * A {@link org.xbib.graph.spanning.SuperVertex} is a collection of vertex objects and is only
    ...
    implements Iterable<V>
{
    ...
    /** The set of vertices combined in this {@link org.xbib.graph.spanning.SuperVertex}. */
    private final Set<V> vertices;

    /** The ordered set of edges to other {@link org.xbib.graph.spanning.SuperVertex} objects. */
    private final TreeSet<WE> orderedEdges;

    /**
     * Create a new {@link org.xbib.graph.spanning.SuperVertex} instance with <code>source</code>
     * as start vertex.
     *
    ...
    /**
     * Merges another {@link org.xbib.graph.spanning.SuperVertex} instance into this one.
     * The edges from the other {@link org.xbib.graph.spanning.SuperVertex} are only added in case
     * they are not to vertices already contained in this {@link org.xbib.graph.spanning.SuperVertex}.
     *
     * @param other the {@link org.xbib.graph.spanning.SuperVertex} to be merged into this
     */
    ...
    /**
     * Returns the edge with the minimum weight to other {@link org.xbib.graph.spanning.SuperVertex}
     * instances.
     *
