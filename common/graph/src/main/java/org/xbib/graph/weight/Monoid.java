...
/**
 * A {@link org.xbib.graph.weight.Monoid} is a {@link Semigroup} with an identity value.
 *
 * @param <E> the type of the elements in the {@link org.xbib.graph.weight.Monoid}
 */
