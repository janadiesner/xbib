package org.xbib.graph.collections;
    ...
    implements Queue<E>
{
    ...
    /**
     * Creates a {@link org.xbib.graph.collections.FibonacciHeap} that orders its elements according to their natural ordering.
     */
    ...
    /**
     * Creates a {@link org.xbib.graph.collections.FibonacciHeap} that orders its elements according to the specified comparator.
     *
     ...
     *
     * @param o1 the first {@link org.xbib.graph.collections.FibonacciHeap} node to be compared
     * @param o2 the second {@link org.xbib.graph.collections.FibonacciHeap} node to be compared
