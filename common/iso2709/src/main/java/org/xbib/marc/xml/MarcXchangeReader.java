...
/**
 * The MarcXchangeL Reader reads MarcXML or MarcXchange and fires events to a SAX content handler
...
public class MarcXchangeReader extends MarcXchangeContentHandler {
    ...
    /*public MarcXchangeReader setListener(MarcXchangeListener listener) {
