...
public abstract class AbstractScriptingEntity implements Entity {
    ...
    public AbstractScriptingEntity(String scriptEngineName, String script, String invocable) {
    ...
    @Override
    public AbstractScriptingEntity setSettings(Map settings) {
        try {
