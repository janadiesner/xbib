...
public class UNIMARCEntityTest extends Assert {
    ...
    private final static Logger logger = LoggerFactory.getLogger(UNIMARCEntityTest.class.getName());
    ...
    public void testUNIMARC() throws IOException {
        ...
        final Iso2709Reader reader = new Iso2709Reader()
                .setTransformer("_default", value -> value == null ? null : new String(value.getBytes(ISO88591), UTF8))
                .setMarcXchangeListener(kv);
