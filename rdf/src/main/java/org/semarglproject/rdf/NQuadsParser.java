 ...
 */
public final class NQuadsParser extends AbstractPipe<QuadSink> implements CharSink {

    private final static Logger logger = LogManager.getLogger(NQuadsParser.class);
