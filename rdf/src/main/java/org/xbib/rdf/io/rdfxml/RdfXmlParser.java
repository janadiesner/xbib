...
public class RdfXmlParser<S extends Identifiable, P extends Property, O extends Node>
    ...
    public RdfXmlParser parse(InputSource source) throws IOException, SAXException {
        parse(XMLReaderFactory.createXMLReader(), source);
        return this;
    }

    public RdfXmlParser parse(XMLReader reader, InputSource source) throws IOException, SAXException {
        if (builder != null) {
    ...
    class Handler extends DefaultHandler implements XmlHandler {
        ...
        @Override
        public Handler setBuilder(Triple.Builder builder) {
            this.builder = builder;
            return this;
        }
