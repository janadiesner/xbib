...
public interface Context<R extends Resource> extends Triple.Builder {
     ...
     * @return this context
     */
    Context<R> setNamespaceContext(IRINamespaceContext namespaceContext);
     ...
     * @return the current resource context
     */
    Context<R> setContentBuilder(ContentBuilder<Context<R>, R> builder);

    Context<R> setWriter(ContextWriter writer);
     ...
     * @return this context
     */
    Context<R> beforeBuild();

    Context<R> afterBuild();
