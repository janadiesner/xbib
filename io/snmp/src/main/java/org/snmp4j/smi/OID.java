...
public class OID extends AbstractVariable
     ...
     *                  is copied. Later changes to <code>prefixOID</code> will therefore not
     *                  affect the OID's value.
     * @param suffixID  an <code>int</code> value that will be appended to the
     *                  <code>prefixOID</code> OID. The array is copied. Later changes to
    ...
    /**
     * Return a string representation that can be parsed again to this {@link org.snmp4j.smi.OID}
     * by {@link #OID(String)}.
     *
