...
public class GenericAddress extends SMIAddress {
    ...
    private static final Logger logger = LogManager.getLogger(GenericAddress.class);
     ...
     * address types are used by the {@link org.snmp4j.smi.GenericAddress#parse(String)}
     ...
     * {@link org.snmp4j.smi.Address} class.
     *
     * @param addressClass an implementation class of {@link org.snmp4j.smi.Address}.
     * @return the corresponding transport domain prefix as defined by the
