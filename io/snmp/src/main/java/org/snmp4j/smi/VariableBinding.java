 ...
 */
public class VariableBinding implements BERSerializable, Cloneable {
     ...
     *
     * @param oid          the {@link org.snmp4j.smi.OID} of the new variable binding.
     * @param variableText the textual representation of a {@link org.snmp4j.smi.Variable} of the syntax defined for <code>oid</code>
     *                     by a MIB specification.
     * @throws java.text.ParseException if the <code>variableText</code> cannot be parsed or <code>oid</code>'s syntax is unknown.
     */
    ...
    /**
     * Create an array of {@link org.snmp4j.smi.VariableBinding}s based on the
     * provided OIDs.
     *
     * @param oids an array of OIDs (must not be null).
     * @return an array of {@link org.snmp4j.smi.VariableBinding}s where each
     ...
     *
     * @param oid an OID (must not be <code>null</code>) that is cloned when added to
     *            this binding.
     */
     ...
     *
     * @param variable a <code>Variable</code> (must not be <code>null</code>) that is cloned
     ...
     *
     * @return a SMI syntax identifier (see {@link org.snmp4j.smi.SMIConstants}).
     */
