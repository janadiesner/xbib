...
public class CipherPool {
     ...
     *
     * @param maxPoolSize the maximum number of ciphers in the pool.
     */
     ...
     * {@link #offerCipher(javax.crypto.Cipher)} when one of its {@link javax.crypto.Cipher#doFinal()}
     * methods have been called and it is not needed anymore.
     *
     * @return a Cipher from the pool, or <code>null</code> if the pool currently does not contain any
     * cipher.
     */
     ...
     *
     * @param cipher a Cipher instance previously acquired by {@link #reuseCipher()} or created externally.
     */
