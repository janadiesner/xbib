...
public class TSM extends SNMPv3SecurityModel {
    ...
    private static final Logger logger = LogManager.getLogger(TSM.class);
     ...
     *
     * @param usePrefix if <code>true</code> the transport domain prefix is prepended to the securityName.
     */
