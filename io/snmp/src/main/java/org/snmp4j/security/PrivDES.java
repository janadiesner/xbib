 ...
 *
 */
public class PrivDES implements PrivacyProtocol {
    ...
    private static final Logger logger = LogManager.getLogger(PrivDES.class);
    protected Salt salt;
     ...
     * @param offset        the offset into <code>cryptedData</code> to start decryption.
