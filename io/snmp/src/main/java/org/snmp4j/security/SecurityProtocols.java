...
public class SecurityProtocols {
    ...
    private static final Logger logger = LogManager.getLogger(SecurityProtocols.class);
     ...
     *
     * @param id The unique ID (specified as {@link org.snmp4j.smi.OID}) of the AuthenticationProtocol.
     ...
     *
     * @param id The unique ID (specified as {@link org.snmp4j.smi.OID}) of the PrivacyProtocol.
     * @return the {@link org.snmp4j.security.PrivacyProtocol} object if it was added before,
     * or null if not.
     */
