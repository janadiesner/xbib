...
public class USM extends SNMPv3SecurityModel {
    ...
    private static final Logger logger = LogManager.getLogger(USM.class);
    ...
    private transient List<UsmUserListener> usmUserListeners;
     ...
     *
     * @param engineID     the engineID of the user (may be <code>null</code> if any target should
     *                     match).
     * @param securityName the security name of the user to earch for.
     * @return <code>true</code> if the user is either known for the specified engine ID
     ...
     * securityName set.
     *
     * @param engineID     an engine ID.
     * @param securityName a security name.
     ...
     *                 like {@link #addUser(org.snmp4j.smi.OctetString userName, UsmUser user)}.
     * @param user     the <code>UsmUser</code> to add.
     */
     ...
     *
     * @param userName a user name.
     * @param engineID the authoritative engine ID associated with the user by localization, or
     *                 <code>null</code> if all users with <code>userName</code> should be
     *                 deleted.
     * @return the removed <code>UsmUser</code> instances as a List. If the user could
     ...
     *          {@link org.snmp4j.event.UsmUserEvent} events.
     */
     ...
     * {@link org.snmp4j.event.CounterEvent}.
     */
     ...
     * provided by the {@link org.snmp4j.mp.CounterSupport} instance is used.
     *
