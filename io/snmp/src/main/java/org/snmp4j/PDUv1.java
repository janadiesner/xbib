 ...
 * is identical to its superclass {@link org.snmp4j.PDU} for the PDU type {@link org.snmp4j.PDU#GET},
 * {@link org.snmp4j.PDU#GETNEXT}, and {@link org.snmp4j.PDU#SET}. The other SNMPv2 PDU types
 * implemented by <code>PDU</code> are not supported. In contrast to its super
 * class, <code>PDUv1</code> implements the {@link org.snmp4j.PDU#V1TRAP} type.
 * <p>
 ...
 * OIDs are defined in {@link org.snmp4j.mp.SnmpConstants}.
 *
 */
public class PDUv1 extends PDU {

    private final static Logger logger = LogManager.getLogger(PDUv1.class);
        ...
        switch (pduType.getValue()) {
            ...
            case PDU.INFORM:
                if (SNMP4JSettings.isAllowSNMPv2InV1()) {
                    ...
                    logger.warn("unsupported by SNMP v1");
                }
                // fall through
            default:
