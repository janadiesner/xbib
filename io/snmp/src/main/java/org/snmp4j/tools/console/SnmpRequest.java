...
public class SnmpRequest implements CommandResponder, PDUFactory {
    ...
    private final static Logger logger = LogManager.getLogger(SnmpRequest.class);
    ...
    public SnmpRequest(String[] args) {
        ...
        if (paramStart >= args.length) {
            ...
            List<VariableBinding> vbs = getVariableBindings(args, paramStart);
    ...
    private static List<VariableBinding> getVariableBindings(String[] args, int position) {
        List<VariableBinding> v = new ArrayList<VariableBinding>(args.length - position + 1);
    ...
    public List<? extends VariableBinding> getVbs() {
        return vbs;
    }
