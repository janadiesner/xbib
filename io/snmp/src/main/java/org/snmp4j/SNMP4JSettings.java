...
public final class SNMP4JSettings {
     ...
     * {@link TransportMapping} and in each {@link org.snmp4j.Snmp} session object. To ensure
    ...
    /**
     * By default SNMP4J uses the {@link org.snmp4j.util.SimpleOIDTextFormat} to convert
    ...
    /**
     * By default SNMP4J uses the {@link org.snmp4j.util.SimpleVariableTextFormat} to convert
     ...
     * {@link org.snmp4j.util.DefaultThreadFactory}, defines the maximum time to wait for a
     ...
     * if otherwise the command generator would not able to receive the {@link org.snmp4j.PDU#REPORT}.
     ...
     * <p>
     * Setting this flag to {@link org.snmp4j.SNMP4JSettings.ReportSecurityLevelStrategy#noAuthNoPrivIfNeeded}
     ...
     *
     * @param newVariableTextFormat the new <code>VariableTextFormat</code> (must not be <code>null</code>).
     */
     ...
     * is set.
     *
     * @param millis the maximum time in milli-seconds to wait for a Thread to join if no
     ...
     * conformity.
     *
     * @param allowSNMPv2InV1 if set to <code>true</code>, SNMP4J will allow Counter64 objects
     ...
     *
     * @return an enterprise ID. For example 4976 as enterprise ID (IANA number) for AGENT++ (SNMP4J).
