...
public interface MessageProcessingModel {
     ...
     * @param messageProcessingModel the {@link org.snmp4j.mp.MessageProcessingModel} ID (typically, the SNMP version).
     * @param securityModel          the security model ID (see {@link org.snmp4j.security.SecurityModel}) to use.
     * @param securityName           the principal on behalf the message is to be sent.
     * @param securityLevel          the level of security requested (see {@link org.snmp4j.security.SecurityLevel}).
     ...
     * @return the status of the message preparation. {@link org.snmp4j.mp.SnmpConstants#SNMP_MP_OK}
     * is returned if on success, otherwise any of the
     * <code>SnmpConstants.SNMP_MP_*</code> values may be returned.
     * @throws java.io.IOException if the supplied PDU could not be encoded to the
     ...
     * is returned if on success, otherwise any of the
     * <code>SnmpConstants.SNMP_MP_*</code> values may be returned.
     * @throws java.io.IOException if an internal error or a resource exception occured.
     */
     ...
     * @param securityModel            returns the security model ID (see {@link org.snmp4j.security.SecurityModel}.
     * @param securityName             returns the principal.
     * @param securityLevel            returns the requested security level (see {@link org.snmp4j.security.SecurityLevel}).
     ...
     * @param statusInformation        returns success or error indication. When an error occured, the error
     *                                 counter OID and value are included.
     * @param mutableStateReference    returns the state reference to be used for a possible response. On input
     ...
     * @return int
     * the status of the message preparation. {@link org.snmp4j.mp.SnmpConstants#SNMP_MP_OK}
     * is returned on success, otherwise any of the
     * <code>SnmpConstants.SNMP_MP_*</code> values may be returned.
     * @throws java.io.IOException if the decoding of the message failed.
     */
