...
public class BER {
    ...
    */
     ...
     * @param length int
     * @throws java.io.IOException if the bytes that are given in length cannot be read from the input
