...
public class Snmp implements Session, CommandResponder {
    ...
    private static final Logger logger = LogManager.getLogger(Snmp.class);
     ...
     *
     * @throws java.io.IOException if a transport mapping throws an <code>IOException</code> when its
     ...
     * <p>
     * If there are any pending requests, the {@link org.snmp4j.event.ResponseListener} associated
     ...
     * {@link org.snmp4j.event.ResponseEvent} returned.
     * <p>
     * After a <code>Session</code> has been closed it must not be used anymore.
     *
     * @throws java.io.IOException if a transport mapping cannot be closed successfully.
     */
     ...
     * {@link org.snmp4j.PDU#GET} and then sends a synchronous request to the supplied
     * target.
     *
     ...
     * {@link org.snmp4j.event.ResponseEvent#getResponse()}. If the request timed out,
     * that method will return <code>null</code>.
     * @throws java.io.IOException if the PDU cannot be sent to the target.
     */
     ...
     * {@link org.snmp4j.PDU#GETNEXT} and then sends a synchronous request to the supplied
     * target. This method is a convenience wrapper for the
     * {@link #send(org.snmp4j.PDU pdu, Target target)} method.
     *
     * @param pdu    a <code>PDU</code> instance. For SNMPv3 messages, the supplied PDU
     *               instance has to be a <code>ScopedPDU</code> instance.
     * @param target the Target instance representing the target SNMP engine where to send
     ...
     * {@link org.snmp4j.PDU#GETBULK} and then sends a synchronous request to the supplied
     * target. This method is a convenience wrapper for the
     * {@link #send(org.snmp4j.PDU pdu, Target target)} method.
     *
     * @param pdu    a <code>PDU</code> instance. For SNMPv3 messages, the supplied PDU
     ...
     * {@link org.snmp4j.PDU#INFORM} and then sends a synchronous request to the supplied
     * target. This method is a convenience wrapper for the
     * {@link #send(org.snmp4j.PDU pdu, Target target)} method.
     *
     * @param pdu    a <code>PDU</code> instance. For SNMPv3 messages, the supplied PDU
     ...
     * {@link org.snmp4j.event.ResponseEvent#getResponse()}. If the request timed out,
     * that method will return <code>null</code>.
     * @throws java.io.IOException if the inform request could not be send to the specified target.
     */
     ...
     * {@link org.snmp4j.PDU#V1TRAP} and then sends it to the supplied target. This method
     * is a convenience wrapper for the  {@link #send(org.snmp4j.PDU pdu, Target target)}
     * method.
     *
     * @param pdu    a <code>PDUv1</code> instance.
     * @param target the Target instance representing the target SNMP engine where to send
     *               the <code>pdu</code>. The selected SNMP protocol version for the
     *               target must be {@link org.snmp4j.mp.SnmpConstants#version1}.
     * @throws java.io.IOException if the trap cannot be sent.
     */
     ...
     * PDU's type to {@link org.snmp4j.PDU#NOTIFICATION} and then sends it to the supplied
     * target. This method is a convenience wrapper for the
     * {@link #send(org.snmp4j.PDU pdu, Target target)} method.
     *
     * @param pdu    a <code>PDUv1</code> instance.
     * @param target the Target instance representing the target SNMP engine where to send
     *               the <code>pdu</code>. The selected SNMP protocol version for the
     *               target must be {@link org.snmp4j.mp.SnmpConstants#version2c} or
     *               {@link org.snmp4j.mp.SnmpConstants#version2c}.
     * @throws java.io.IOException if the notification cannot be sent.
     */
     ...
     * {@link org.snmp4j.PDU#SET} and then sends a synchronous request to the supplied
     * target.
     *
     * @param pdu    a <code>PDU</code> instance. For SNMPv3 messages, the supplied PDU
     *               instance has to be a <code>ScopedPDU</code> instance.
     ...
     * @throws java.io.IOException if the transport fails to send the PDU or the if the message cannot
     *                             be BER encoded.
     */
     ...
     * @see org.snmp4j.mp.MPv3
     * @see org.snmp4j.security.USM
     */
     ...
     * flag in {@link org.snmp4j.security.USM} must be <code>true</code> (which is the default).
     * </em>
     *
     ...
     * @see org.snmp4j.security.USM#setEngineDiscoveryEnabled(boolean enableEngineDiscovery)
     */
     ...
     * that uses the {@link org.snmp4j.mp.MPv3#getSecurityModel} method of the associated MPv3
     ...
     *
     * @param messageProcessingModel a mesage processing model ID as defined in {@link org.snmp4j.mp.MessageProcessingModel}.
     ...
     * The default value is <code>false</code>.
     *
     * @param contextEngineIdDiscoveryDisabled <code>true</code> to disable context engine ID discovery,
