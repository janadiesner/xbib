...
public class MessageException extends IOException {
     ...
     * @param snmp4jErrorStatus a {@link org.snmp4j.mp.MessageProcessingModel} or {@link org.snmp4j.security.SecurityModel}
     ...
     * @param snmp4jErrorStatus a {@link org.snmp4j.mp.MessageProcessingModel} or {@link org.snmp4j.security.SecurityModel}
     *                          specific error status as defined by {@link org.snmp4j.mp.SnmpConstants}.
     * @param rootCause         the root cause represented by a Throwable.
     */
     ...
     *
     * @return a {@link org.snmp4j.mp.MessageProcessingModel} or {@link org.snmp4j.security.SecurityModel}
     * specific error status as defined by {@link org.snmp4j.mp.SnmpConstants}.
     */
