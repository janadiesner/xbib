...
public interface TlsTmSecurityCallback<C extends Certificate> {
     ...
     *
     * @param peerCertificateChain an array of {@link java.security.cert.Certificate}s with the peer's own certificate
     ...
     *
     * @param peerEndCertificate a client Certificate instance to check acceptance for.
     * @return <tt>true</tt> if the certificate is accepted.
     */
     ...
     *
     * @param peerCertificateChain a server Certificate chain to check acceptance for.
     * @return <tt>true</tt> if the certificate chain is accepted.
     */
     ...
     *
     * @param issuerCertificate an issuer Certificate instance to check acceptance for.
     * @return <tt>true</tt> if the certificate is accepted.
     */
     ...
     * target address.
     *
     * @param targetAddress a target address or <tt>null</tt> if the default local
     *                      certificate alias needs to be retrieved.
     * @return the requested local certificate alias, if known.
