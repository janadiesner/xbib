...
public class TLSTM extends TcpTransportMapping {
    ...
    private static final Logger logger = LogManager.getLogger(TLSTM.class);
     ...
     * messages disabled.
     *
     * @throws java.net.UnknownHostException if the local host cannot be determined.
     */
     ...
     *                         {@link org.snmp4j.mp.CounterSupport#getInstance()}.
     * @throws java.io.IOException if the given address cannot be bound.
     */
    public TLSTM(TlsTmSecurityCallback<X509Certificate> securityCallback,
     ...
     *
     * @param tlsProtocols an array of TLS protocol (version) names supported by the SunJSSE provider.
     ...
     *
     * @param trustManagerFactory a X.509 trust manager factory implementing the interface {@link org.snmp4j.transport.TLSTM.TLSTMTrustManagerFactory}.
     */
     ...
     *
     * @throws java.net.SocketException when the transport is already listening for incoming/outgoing messages.
...
/*
    ...
    */
     ...
     * nothing.
     *
     * @param serverSocket the <code>ServerSocket</code> to apply additional non-default options.
     */
    ...
    static interface SSLEngineConfigurator {
         ...
         * cipher codes, etc.
         *
         * @param sslEngine a {@link javax.net.ssl.SSLEngine} to configure.
         */
         ...
         *
         * @param useClientMode           <code>true</code> if the connection is established in client mode.
