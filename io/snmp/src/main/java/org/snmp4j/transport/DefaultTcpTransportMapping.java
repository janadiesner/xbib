...
public class DefaultTcpTransportMapping extends TcpTransportMapping {
    ...
    private static final Logger logger = LogManager.getLogger(DefaultTcpTransportMapping.class);
     ...
     * {@link org.snmp4j.transport.DefaultTcpTransportMapping.SnmpMesssageLengthDecoder}. The message length decoder must be
