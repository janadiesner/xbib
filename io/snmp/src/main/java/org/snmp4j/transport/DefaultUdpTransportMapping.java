...
public class DefaultUdpTransportMapping extends UdpTransportMapping {
    ...
    private static final Logger logger = LogManager.getLogger(DefaultUdpTransportMapping.class);
     ...
     *
     * @param socketTimeout the socket timeout for incoming messages in milliseconds.
    ...
    /**
     * If receiving new datagrams fails with a {@link java.net.SocketException}, this method is called to renew the
     * socket - if possible.
     *
     * @param socketException the exception that occurred.
     * @param failedSocket    the socket that caused the exception. By default, he socket will be closed
     ...
     * @return the new socket or <code>null</code> if the listen thread should be terminated with the provided
     * exception.
     * @throws java.net.SocketException a new socket exception if the socket could not be renewed.
     */
