 ...
 * messages using {@link org.snmp4j.mp.MessageProcessingModel} instances and encodes
 * and sends outgoing messages using an appropriate {@link org.snmp4j.TransportMapping}
 * instances.
 * <p>
 ...
 *
 * @see org.snmp4j.Snmp
 * @see org.snmp4j.TransportMapping
 * @see org.snmp4j.mp.MessageProcessingModel
 * @see org.snmp4j.mp.MPv1
 * @see org.snmp4j.mp.MPv2c
 * @see org.snmp4j.mp.MPv3
 */
public class MessageDispatcherImpl implements MessageDispatcher {

    private static final Logger logger = LogManager.getLogger(MessageDispatcherImpl.class);
     ...
     * @throws java.io.IOException if an I/O error occurred while sending the message or if there is
     ...
     * @throws java.io.IOException if the message cannot be decoded.
     */
     ...
     * @throws org.snmp4j.MessageException if unrecoverable inconsistencies have been detected.
     */
