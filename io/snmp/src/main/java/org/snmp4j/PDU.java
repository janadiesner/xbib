...
public class PDU implements BERSerializable {
    ...
    /**
     * Constructs a new PDU from a type and a list of {@link org.snmp4j.smi.VariableBinding} instances.
     ...
     * {@link org.snmp4j.mp.SnmpConstants#SNMP_ERROR_MESSAGES} array for a valid error status.
     ...
     * {@link #add(org.snmp4j.smi.VariableBinding vb)}).
     *
     ...
     * {@link #add(org.snmp4j.smi.VariableBinding vb)}).
     *
     * @param vbs a list of <code>VariableBinding</code> instances. The instances in the
     ...
     * {@link #addOID(org.snmp4j.smi.VariableBinding vb)}).
     *
     ...
     *
     * @param prefix the search {@link org.snmp4j.smi.OID}.
     * @return the {@link org.snmp4j.smi.Variable} of the first {@link org.snmp4j.smi.VariableBinding}
    ...
    /**
     * Gets a list of {@link org.snmp4j.smi.VariableBinding}s whose OID prefix
     * matches the supplied prefix.
     *
     * @param prefix the search {@link org.snmp4j.smi.OID}.
     * @return a List of all {@link org.snmp4j.smi.VariableBinding}s
     * whose prefix matches <code>oid</code>. If no such element
    ...
    /**
     * Sets the {@link org.snmp4j.smi.VariableBinding}s for this PDU.
     *
     * @param vbs a list of {@link org.snmp4j.smi.VariableBinding} instances which must
     *            not be null.
     */
     ...
     * @see org.snmp4j.mp.SnmpConstants
     */
    ...
    /**
     * Gets the PDU type. The default is {@link org.snmp4j.PDU#GETNEXT}.
     *
