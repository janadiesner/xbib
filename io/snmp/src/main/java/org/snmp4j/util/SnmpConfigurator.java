 ...
 * In addition, a {@link org.snmp4j.util.PDUFactory} and {@link Target} can be created using
...
public class SnmpConfigurator {
     ...
     *
     * @param s             the string value to convert. If it starts with <code>0x</code> its
