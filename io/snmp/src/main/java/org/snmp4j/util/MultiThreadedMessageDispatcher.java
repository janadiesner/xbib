 ...
 * sourceTransport, org.snmp4j.smi.Address incomingAddress, java.nio.ByteBuffer wholeMessage,
...
public class MultiThreadedMessageDispatcher implements MessageDispatcher {
     ...
     *
     * @param workerPool          a <code>WorkerPool</code> instance (that can be shared). <em>The worker
