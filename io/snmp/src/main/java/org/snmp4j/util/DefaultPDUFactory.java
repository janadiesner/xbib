...
public class DefaultPDUFactory implements PDUFactory {
    ...
    /**
     * Creates a {@link org.snmp4j.util.PDUFactory} with type and context information.
     *
     * @param pduType         a PDU type as specified by {@link PDU}.
     * @param contextEngineID a context engine ID to be used when creating {@link ScopedPDU}s.
     * @param contextName     a context name to be used when creating {@link ScopedPDU}s.
     */
     ...
     *                       sent.
     * @param pduType        a PDU type as specified by {@link PDU}.
     * @param maxRepetitions the maximum number of repetitions for GETBULK PDUs created
     *                       by this factory.
     * @param nonRepeaters   the number of non-repeater variable bindings
     ...
     *
     * @param targetVersion a SNMP version as defined by {@link org.snmp4j.mp.SnmpConstants}.
    ...
    /**
     * Creates a <code>PDU</code> instance for the specified {@link org.snmp4j.mp.MessageProcessingModel} and PDU type.
     *
     * @param messageProcessingModel a message processing model instance.
     * @param pduType                the type for the new PDU.
     * @return a PDU that is compatible with the specified message processing model.
     */
    ...
    /**
     * Creates a <code>PDU</code> instance for the specified {@link org.snmp4j.mp.MessageProcessingModel}.
     *
     * @param messageProcessingModel a message processing model instance.
     * @return a PDU that is compatible with the specified message processing model.
     */
     ...
     *
     * @return the maximum number of repetitions for GETBULK PDUs created
     * by this factory.
     */
     ...
     *
     * @return the number of non-repeater variable bindings
     * (processed like GETNEXT) for GETBULK PDUs created
     * by this factory.
     */
     ...
     * by this factory.
     *
     * @return the context engine ID or <code>null</code> if context engine ID is
     ...
     * by this factory.
     *
     * @param contextEngineID the context engine ID or <code>null</code> if context engine ID is
     *                        the same as authoritative engine ID.
     */
     ...
     * by this factory.
     *
     * @return the context name or <code>null</code> for the default context.
     */
     ...
     * by this factory.
     *
     * @param contextName the context name or <code>null</code> for the default context.
     */
