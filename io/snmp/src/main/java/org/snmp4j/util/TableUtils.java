...
public class TableUtils extends AbstractSnmpUtility {
     ...
     * The data is returned row-by-row as a list of {@link org.snmp4j.util.TableEvent} instances.
     ...
     * @return a <code>List</code> of {@link org.snmp4j.util.TableEvent} instances. Each instance
     * represents successfully retrieved row or an error condition. Error
     * conditions (any status other than {@link org.snmp4j.util.TableEvent#STATUS_OK})
     ...
     *                        prefix. Note: The result of this method is not defined if instance OIDs
     *                        are supplied in this array!
     * @param listener        a <code>TableListener</code> that is called with {@link org.snmp4j.util.TableEvent}
     ...
     * status for {@link org.snmp4j.mp.SnmpConstants#SNMP_ERROR_SUCCESS} to verify that the
    ...
    public class TableRequest implements ResponseListener {
        ...
        private TableEvent getTableEvent() {
            ...
            VariableBinding[] vbs = r.toArray(new VariableBinding[r.size()]);
