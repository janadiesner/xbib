...
public class TreeUtils extends AbstractSnmpUtility {
     ...
     * @param target   a <code>Target</code> that specifies the target command responder
     *                 including its network transport address.
     * @param rootOIDs the OIDs which specify the subtrees to walk. Each OID defines a sub-tree
     ...
     *                 (i.e., {@link org.snmp4j.smi.Null#endOfMibView}) or for each rootOIDs element, the returned
     ...
     * @param listener   the <code>TreeListener</code> that processes the {@link org.snmp4j.util.TreeEvent}s
     ...
     *                   {@link org.snmp4j.util.TreeEvent} contains the variable bindings of each iteration.
     */
     ...
     *
     * @param ignoreLexicographicOrder <code>true</code> to ignore lexicographic order errors,
     *                                 <code>false</code> otherwise (default).
     */
