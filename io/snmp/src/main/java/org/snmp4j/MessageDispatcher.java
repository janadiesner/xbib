...
public interface MessageDispatcher extends TransportListener {
     ...
     * @param target           the target which identifies, transport address, message processing model,
     ...
     * a call to {@link #sendPdu(org.snmp4j.TransportMapping transportMapping, org.snmp4j.Target target,
     * org.snmp4j.PDU pdu, boolean expectResponse)}
     ...
     * @return an MP error status or {@link org.snmp4j.mp.SnmpConstants#SNMP_MP_OK} if
     * the operation was successful.
     * @throws org.snmp4j.MessageException if message processing fails with a fatal error.
     */
