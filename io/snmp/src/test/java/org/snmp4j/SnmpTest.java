...
public class SnmpTest extends Assert {

    private static DummyTransport<UdpAddress> transportMappingCG;
    private static AbstractTransportMapping<UdpAddress> transportMappingCR;
    private static Snmp snmpCommandGenerator;
    private static Snmp snmpCommandResponder;
