...
public interface PoolConfiguration {
     ...
     * @see org.xbib.io.jdbc.pool.tomcat.interceptor.ResetAbandonedTimer
     */
     ...
     * Example interceptors are {@link org.xbib.io.jdbc.pool.tomcat.interceptor.StatementFinalizer StatementFinalizer} to close all
     * used statements during the session.
     * {@link org.xbib.io.jdbc.pool.tomcat.interceptor.ResetAbandonedTimer ResetAbandonedTimer} resets the timer upon every operation
     * on the connection or a statement.
     * {@link org.xbib.io.jdbc.pool.tomcat.interceptor.ConnectionState ConnectionState} caches the auto commit, read only and catalog settings to avoid round trips to the DB.
     * The default value is null.
     *
    ...
    /**
     * If set to true, the connection pool creates a {@link org.xbib.io.jdbc.pool.tomcat.jmx.ConnectionPoolMBean} object
