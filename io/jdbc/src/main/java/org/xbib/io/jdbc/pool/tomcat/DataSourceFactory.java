...
public class DataSourceFactory implements ObjectFactory {
    ...
    private static final Logger log = LogManager.getLogger(DataSourceFactory.class.getSimpleName());
    ...
    public Object getObjectInstance(Object obj, Name name, Context nameCtx,
        ...
        if (org.xbib.io.jdbc.pool.tomcat.DataSource.class.getName().equals(ref.getClassName())) {
            ok = true;
        }
    ...
    public DataSource createDataSource(Properties properties, Context context, boolean XA) throws Exception {
        ...
        org.xbib.io.jdbc.pool.tomcat.DataSource dataSource = XA ?
                new XADataSource(poolProperties) :
                new org.xbib.io.jdbc.pool.tomcat.DataSource(poolProperties);
