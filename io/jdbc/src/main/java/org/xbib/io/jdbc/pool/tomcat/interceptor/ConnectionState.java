...
import org.xbib.io.jdbc.pool.tomcat.DataSourceFactory;
 ...
 * The {@link org.xbib.io.jdbc.pool.tomcat.ConnectionPool} is optimized to do as little work as possible.
 ...
 * In the cases where the application code doesn't know or want to keep track of the state,
 * this interceptor helps cache the
 * state, and it also avoids roundtrips to the database asking for it.
 */

public class ConnectionState extends JdbcInterceptor {

    private static final Logger log = LogManager.getLogger(ConnectionState.class.getSimpleName());
