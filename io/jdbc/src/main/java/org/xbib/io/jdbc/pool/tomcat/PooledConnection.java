...
import org.xbib.io.jdbc.pool.tomcat.interceptor.ConnectionState;
...
public class PooledConnection {
     ...
     * Logger
     */
    private static final Logger log = LogManager.getLogger(PooledConnection.class.getSimpleName());
    ...
    protected void connectUsingDriver() throws SQLException {
        ...
        try {
            ...
            if (parent.jmxPool != null) {
                parent.jmxPool.notify(org.xbib.io.jdbc.pool.tomcat.jmx.ConnectionPool.NOTIFY_CONNECT,
...
//============================================================================
     ...
     * This timestamp can also be reset by the {@link org.xbib.io.jdbc.pool.tomcat.interceptor.ResetAbandonedTimer#invoke(Object, java.lang.reflect.Method, Object[])}
     *
