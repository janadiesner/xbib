...
import org.xbib.io.jdbc.pool.tomcat.PoolProperties.InterceptorDefinition;
import org.xbib.io.jdbc.pool.tomcat.PoolUtilities;
import org.xbib.io.jdbc.pool.tomcat.Validator;
...
public class ConnectionPool extends NotificationBroadcasterSupport implements ConnectionPoolMBean {
     ...
     * the connection pool
     */
    protected org.xbib.io.jdbc.pool.tomcat.ConnectionPool pool = null;
    /**
    ...
    public ConnectionPool(org.xbib.io.jdbc.pool.tomcat.ConnectionPool pool) {
        super();
        this.pool = pool;
    }

    public org.xbib.io.jdbc.pool.tomcat.ConnectionPool getPool() {
        return pool;
    }
