...
public class PlainSelect implements SelectBody {
	...
	/**
	 * The {@link org.xbib.sql.parser.statement.select.FromItem} in this query
	 * @return the {@link org.xbib.sql.parser.statement.select.FromItem}
	 */
	...
	/**
	 * The {@link org.xbib.sql.parser.statement.select.SelectItem}s in this query (for example the A,B,C in "SELECT A,B,C")
	 * @return a list of {@link org.xbib.sql.parser.statement.select.SelectItem}s
	 */
	...
	/**
	 * The list of {@link org.xbib.sql.parser.statement.select.Join}s
	 * @return the list of {@link org.xbib.sql.parser.statement.select.Join}s
	 */
	...
	/**
	 * A list of {@link org.xbib.sql.parser.expression.Expression}s of the GROUP BY clause.
	 * It is null in case there is no GROUP BY clause
	 * @return a list of {@link org.xbib.sql.parser.expression.Expression}s
	 */
	 ...
	 * @see #getStringList(java.util.List, boolean, boolean)
	 * @param list
