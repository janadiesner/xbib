...
import org.xbib.sql.parser.statement.create.table.ColumnDefinition;
import org.xbib.sql.parser.statement.create.table.CreateTable;
import org.xbib.sql.parser.statement.create.table.Index;

import java.util.Iterator;

/**
 * A class to de-parse (that is, tranform from JSqlParser hierarchy into a string)
 * a {@link org.xbib.sql.parser.statement.create.table.CreateTable}
 */
