...
import org.xbib.sql.parser.expression.AllComparisonExpression;
import org.xbib.sql.parser.expression.AnyComparisonExpression;
import org.xbib.sql.parser.expression.BinaryExpression;
import org.xbib.sql.parser.expression.CaseExpression;
import org.xbib.sql.parser.expression.DateValue;
import org.xbib.sql.parser.expression.DoubleValue;
import org.xbib.sql.parser.expression.Expression;
import org.xbib.sql.parser.expression.ExpressionVisitor;
import org.xbib.sql.parser.expression.Function;
import org.xbib.sql.parser.expression.InverseExpression;
import org.xbib.sql.parser.expression.JdbcParameter;
import org.xbib.sql.parser.expression.LongValue;
import org.xbib.sql.parser.expression.NullValue;
import org.xbib.sql.parser.expression.Parenthesis;
import org.xbib.sql.parser.expression.StringValue;
import org.xbib.sql.parser.expression.TimeValue;
import org.xbib.sql.parser.expression.TimestampValue;
import org.xbib.sql.parser.expression.WhenClause;
 ...
 * an {@link org.xbib.sql.parser.expression.Expression}
 */
