...
public class HandlebarsContext {
     ...
     * Handlebars 'parent' attribute reference.
     */
    private static final String PARENT = "src/test";
    ...
    private static class CompositeValueResolver implements ValueResolver {
        ...
        /**
         * Creates a new {@link HandlebarsContext.CompositeValueResolver}.
         *
        ...
        public Set<Entry<String, Object>> propertySet(final Object context) {
            Set<Entry<String, Object>> propertySet = new LinkedHashSet<Entry<String, Object>>();
            for (ValueResolver resolver : resolvers) {
    ...
    public static final class Builder {
         ...
         */
        private Builder(final HandlebarsContext parent, final Object model) {
            context = HandlebarsContext.child(parent, model);
        }
        ...
        private Builder(final Object model) {
            context = HandlebarsContext.root(model);
        }
        ...
        public Builder resolver(final ValueResolver... resolvers) {
            Validate.notEmpty(resolvers, "At least one value-resolver must be present.");
         ...
         */
        public HandlebarsContext build() {
     ...
     */
    public static final String PARTIALS = HandlebarsContext.class.getName() + "#partials";

    /**
     * The qualified name for partials. Internal use.
     */
    public static final String INVOCATION_STACK = HandlebarsContext.class.getName() + "#invocationStack";

    /**
     * Number of parameters of a helper. Internal use.
     */
    public static final String PARAM_SIZE = HandlebarsContext.class.getName() + "#paramSize";

    /**
     * The parent context. Optional.
     */
    private HandlebarsContext parent;
     ...
     */
    private HandlebarsContext extendedContext;
     ...
     *              templates. Required.
     */
    protected HandlebarsContext(final Object model) {
     ...
     */
    private static HandlebarsContext root(final Object model) {
        HandlebarsContext root = new HandlebarsContext(model);
        root.extendedContext = new HandlebarsContext(new HashMap<String, Object>());
        root.parent = null;
     ...
     */
    private static HandlebarsContext child(final HandlebarsContext parent, final Object model) {
        Validate.notNull(parent, "A parent context is required.");
        HandlebarsContext child = new HandlebarsContext(model);
        child.extendedContext = new HandlebarsContext(new HashMap<String, Object>());
        child.parent = parent;
    ...
    private void combine(final String name, final Object model) {
        Validate.notEmpty(name, "The variable's name is required.");
     ...
     * @return This context.
     */
    public HandlebarsContext data(final String name, final Object value) {
        Validate.notEmpty(name, "The attribute's name is required.");
        data.put(name, value);
        return this;
    }
     ...
     * @return This context.
     */
    public HandlebarsContext data(final Map<String, ?> attributes) {
        Validate.notNull(attributes, "The attributes are required.");
     ...
     */
    public HandlebarsContext parent() {
        return parent;
    }
    ...
    public Set<Entry<String, Object>> propertySet(final Object context) {
        ...
        if (context instanceof HandlebarsContext) {
            return resolver.propertySet(((HandlebarsContext) context).model);
        }
        ...
        if (value == null) {
            ...
            if (value == null && data != null) {
                ...
                if (value == null && path.length > 1) {
                    ...
                    HandlebarsContext dataContext = HandlebarsContext.newBuilder(data)
     ...
     */
    private Object get(final HandlebarsContext external, final String key) {
     ...
     * the parent context.
     * If the value is NULL the search must stop bc the context for
     ...
     */
    public static Builder newBuilder(final HandlebarsContext parent, final Object model) {
        Validate.notNull(parent, "The parent context is required.");
     ...
     */
    public static HandlebarsContext newContext(final HandlebarsContext parent, final Object model) {
     ...
     */
    public static HandlebarsContext newContext(final Object model) {
