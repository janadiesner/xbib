...
package org.xbib.web.dispatcher.thu;
...
@Path("/thu")
public class THUService extends HandlebarsService {
    ...
    public Response get(@Context HttpServletRequest request,
        ...
        if (id != null) {
            ...
            DispatcherSettings dispatcherSettings = DispatcherSettings.Factory.getDispatcherSettings("thu");
