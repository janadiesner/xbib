...
package org.xbib.web.dispatcher.saa;
...
@Path("/saa")
public class SAAService extends HandlebarsService {
    ...
    public Response get(@Context HttpServletRequest request,
        ...
        if (id != null) {
            ...
            DispatcherSettings dispatcherSettings = DispatcherSettings.Factory.getDispatcherSettings("saa");
