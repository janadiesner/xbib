...
package org.xbib.web.dispatcher.ham;
...
@Path("/ham")
public class HAMService extends HandlebarsService {
    ...
    public Response get(@Context HttpServletRequest request,
        ...
        if (id != null) {
            ...
            DispatcherSettings dispatcherSettings = DispatcherSettings.Factory.getDispatcherSettings("ham");
