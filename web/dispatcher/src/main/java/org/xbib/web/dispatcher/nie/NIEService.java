...
package org.xbib.web.dispatcher.nie;
...
@Path("/nie")
public class NIEService extends HandlebarsService {
    ...
    public Response get(@Context HttpServletRequest request,
        ...
        if (id != null) {
            ...
            DispatcherSettings dispatcherSettings = DispatcherSettings.Factory.getDispatcherSettings("nie");
