...
public class TarArchiveOutputStream extends ArchiveOutputStream<TarArchiveOutputEntry> implements TarConstants {
    ...
    public void putArchiveEntry(TarArchiveOutputEntry archiveEntry) throws IOException {
        ...
        TarArchiveOutputEntry entry = (TarArchiveOutputEntry) archiveEntry;
    ...
    @Override
    public TarArchiveOutputEntry createArchiveEntry(File inputFile, String entryName) throws IOException {
        if (finished) {
            throw new IOException("Stream has already been finished");
        }
        return new TarArchiveOutputEntry(inputFile, entryName);
    }
