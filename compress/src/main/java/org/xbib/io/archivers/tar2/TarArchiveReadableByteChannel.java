...
public class TarArchiveReadableByteChannel extends ArchiveInputStream<TarArchiveInputEntry> implements TarConstants {
    ...
    public TarArchiveReadableByteChannel(ReadableByteChannel channel) throws IOException {
    ...
    private byte[] readRecord() throws IOException {
        ...
        try {
            ...
            buffer.get(result, (currRecIdx * recordSize), recordSize);
