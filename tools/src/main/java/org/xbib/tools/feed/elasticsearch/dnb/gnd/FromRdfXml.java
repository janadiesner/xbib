...
/**
 * Feed GND from RDF/XML to ELasticsearch
 */
public class FromRdfXml extends Feeder implements TripleListener {
    ...
    public void process(URI uri) throws Exception {
        ...
        namespaceContext.addNamespace("geo", "http://www.opengis.net/ont/geosparql#");
        context = new SimpleResourceContext();
    ...
    @Override
    public FromRdfXml newIdentifier(IRI iri) {
    ...
    @Override
    public FromRdfXml triple(Triple triple) {
