...
import org.xbib.tools.elasticsearch.merge.zdb.entities.BlackListedISIL;
...
public class WithHoldingsAndLicenses
    ...
    private WithHoldingsAndLicenses() {}
    ...
    public WithHoldingsAndLicenses run() throws Exception {
        ...
        String filename = String.format("notindexed-%04d%02d%02d.txt", year, month+1, day);
