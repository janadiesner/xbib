...
public class EnumerationAndChronology {
    ...
    private final static Pattern[] p1a = new Pattern[] {
            // 1921=1339
            // 1921/22=1339
            Pattern.compile("(\\d{4})(/?\\d{2})\\s*=", Pattern.UNICODE_CHARACTER_CLASS),
            // 1965/70(1971/72)
            Pattern.compile("(\\d{4})(/?\\d{2})\\((\\d{4})(/?\\d{2})\\)", Pattern.UNICODE_CHARACTER_CLASS),
            // 1965/66
            // 1968/70
            // 1961/62(1963)
            // 1961/62(1962)
            // WS 1948/49
            Pattern.compile("(\\d{4})(/?\\d{2})", Pattern.UNICODE_CHARACTER_CLASS),
            // 1961
            // 1992,14140(12. März)
            // SS 1922
            Pattern.compile("(\\d{4})", Pattern.UNICODE_CHARACTER_CLASS)
    };
    private final static Pattern[] p1b = new Pattern[]{
            // 1.1970/71
            // 2.1938/40(1942)
            // 9.1996/97(1997)
            Pattern.compile("(\\d+)\\.(\\d{4})(/\\d{0,4})", Pattern.UNICODE_CHARACTER_CLASS),
            // 1.1970
            // 2.1970,3
            // 4.1961,Aug.
            // 3.1971,Jan./Febr.
            // 1.1970; 3.1972; 7.1973
            Pattern.compile("(\\d+)\\.(\\d{4})", Pattern.UNICODE_CHARACTER_CLASS),
            // 1.[19]93,1
            Pattern.compile("(\\d+)\\.(\\[?\\d{2}\\]?\\d{2}/?\\d{0,4})", Pattern.UNICODE_CHARACTER_CLASS)
    };
    private final static Pattern[] p1c = new Pattern[] {
            // An V= [1796/97]
            // 1.5678=[1917/18]
            Pattern.compile("=\\s*\\[(\\d{4})(/?\\d{0,4})\\]", Pattern.UNICODE_CHARACTER_CLASS),
            // 1.1981=1401
            Pattern.compile("\\.(\\d{4}/?\\d{0,4})\\s*=", Pattern.UNICODE_CHARACTER_CLASS)
    };
    private final static Pattern[] p2a = new Pattern[] {
            // 1971 -
            Pattern.compile("(\\d{4}/?\\d{0,4}).*\\-\\s*$", Pattern.UNICODE_CHARACTER_CLASS),
            // 1963,21(22.Mai) -
            Pattern.compile("(\\d{4}).*\\-\\s*$", Pattern.UNICODE_CHARACTER_CLASS),
            // [19]51,1 - [19]52,5
            Pattern.compile("(\\[\\d{2}\\]\\d{2}).*\\-\\s*$", Pattern.UNICODE_CHARACTER_CLASS)
    };
    private final static Pattern[] p2b = new Pattern[] {
            // 1.1971 -
            // 2.1947,15.Mai -
            Pattern.compile("(\\d+)\\.(\\d{4}/?\\d{0,4}).*\\-\\s*$", Pattern.UNICODE_CHARACTER_CLASS)
    };

    private final static Pattern[] p3a = new Pattern[] {
            // 1963 - 1972
            Pattern.compile("(\\d{4}/?\\d{0,4}).*\\-\\s*(\\d{4}/?\\d{0,4})", Pattern.UNICODE_CHARACTER_CLASS),
            // [19]51,1 - [19]52,5
            Pattern.compile("(\\[\\d{2}\\]\\d{2}/?\\d{0,4}).*\\-\\s*(\\[\\d{2}\\]\\d{2}/?\\d{0,4})", Pattern.UNICODE_CHARACTER_CLASS)
    };
    private final static Pattern[] p3b = new Pattern[] {
            ...
            // 3.1858,6 - 24.1881,3
            // 1.1960 - 5.1963
            Pattern.compile("(\\d+)\\.(\\d{4}/?\\d{0,4}).*\\-\\s*(\\d+)\\.(\\d{4}/?\\d{0,4})", Pattern.UNICODE_CHARACTER_CLASS),
            // [19]81/82 - [19]83
            Pattern.compile("(\\d+)\\.(\\[\\d{2}\\]\\d{2})(/\\d{0,4}).*\\-\\s*(\\d+)\\.(\\[\\d{2}\\]\\d{2})(/\\d{0,4})", Pattern.UNICODE_CHARACTER_CLASS),
            // 1.[19]51,1 - 1.[19]52,5
            Pattern.compile("(\\d+)\\.(\\[\\d{2}\\]\\d{2}).*\\-\\s*(\\d+)\\.(\\[\\d{2}\\]\\d{2})", Pattern.UNICODE_CHARACTER_CLASS)
    };
    private final static Pattern[] p4a = new Pattern[] {
            ...
            // 1961/62(1963)
            // 1965/70(1971/72)
            Pattern.compile("\\((\\d{4}/?\\d{0,4})\\)", Pattern.UNICODE_CHARACTER_CLASS)
    };
