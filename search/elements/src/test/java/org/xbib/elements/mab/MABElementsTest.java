...
public class MABElementsTest {
    ...
    public void testSetupOfMABElements() throws Exception {
        MABElementMapper mapper = new MABElementMapper("mab/hbz/tit").start();
        Writer writer = new FileWriter("target/mab-hbz-tit-elements.json");
        mapper.dump("mab/hbz/tit", writer);
    ...
    public void testZDBMABElements() throws Exception {
        InputStream in =  InputService.getInputStream(URI.create("file:src/test/resources/org/xbib/elements/mab/1217zdbtit.dat"));
        ...
        MABElementMapper mapper = new MABElementMapper("mab/hbz/tit")
