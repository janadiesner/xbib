    ...
    public boolean fields(MARCPipeline pipeline, ElementBuilder<FieldCollection, String, MARCElement, MARCContext> builder,
        ...
        switch (publicationStatus) {
            case "b" :
                ...
                break;
            case "c":
                publicationStatusText = "Continuing getResource currently published";
                break;
            case "d":
                publicationStatusText = "Continuing getResource ceased publication";
                break;
            case "e":
            ...
            case "t":
                ...
                break;
            case "u":
                publicationStatusText = "Continuing getResource status unknown";
                break;
        }
