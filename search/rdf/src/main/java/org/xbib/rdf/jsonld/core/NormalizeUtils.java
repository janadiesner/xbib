...
import static org.xbib.rdf.jsonld.core.RDFDatasetUtils.parseNQuads;
import static org.xbib.rdf.jsonld.core.RDFDatasetUtils.toNQuad;
                        ...
                        if (pgi == hashes.size()) {
                            ...
                            if (options.getFormat() != null) {
                                if ("application/nquads".equals(options.getFormat())) {
                                    ...
                                    throw new JsonLdError(Error.UNKNOWN_FORMAT,
                                            options.getFormat());
                                }
                            }
                            String rval = "";
