 ...
 */
package org.xbib.elasticsearch.tools.feed.oai;
 ...
 */
public class OAI extends Feeder {

    private final Logger logger = LoggerFactory.getLogger(OAI.class.getSimpleName());
    ...
    @Override
    protected OAI prepare(Ingest output) {
        return this;
    }
