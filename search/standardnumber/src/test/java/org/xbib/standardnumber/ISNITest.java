...
public class ISNITest extends Assert {
    ...
    public void testISNI() throws Exception {
        ...
        ISNI isni = new ISNI().setValue(value).parse().verify();
        assertEquals("0000000218250097", isni.getValue());
    ...
    public void testISNI2() throws Exception {
        ...
        ISNI isni = new ISNI().setValue(value).parse().verify();
        assertEquals("1422458635730476", isni.getValue());
    ...
    public void testISNI3() throws Exception {
        ...
        ISNI isni = new ISNI().setValue(value).checksum().parse().verify();
        assertEquals("8462832856536436", isni.getValue());
    ...
    public void testISNI4() throws Exception {
        ...
        ISNI isni = new ISNI().setValue(value).checksum().parse().verify();
        assertEquals("0023000010011235", isni.getValue());
    ...
    public void testISNI5() throws Exception {
        ...
        ISNI isni = new ISNI().setValue(value).parse().verify();
        assertEquals("0000000121953271", isni.getValue());
