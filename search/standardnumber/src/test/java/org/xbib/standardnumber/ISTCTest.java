...
public class ISTCTest extends Assert {
    ...
    public void testISTC() throws Exception {
        ...
        assertEquals("0A920021223F3320", istc.normalized());
    ...
    public void testISTC2() throws Exception {
        ...
        assertEquals("A022009000004BEA", istc.normalized());
    ...
    public void testISTC3() throws Exception {
        ...
        assertEquals("0A9200912B4A105C", istc.normalized());
    ...
    public void testISTC4() throws Exception {
        ...
        assertEquals("0A9200212B4A1057", istc.normalized());
    ...
    public void testISTC5() throws Exception {
        ...
        assertEquals("A02200900000A87C", istc.normalized());
    ...
    public void testISTC6() throws Exception {
        ...
        assertEquals("A02201031F4CB2CB", istc.normalized());
