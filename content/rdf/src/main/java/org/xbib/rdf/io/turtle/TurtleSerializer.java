...
/**
 * Implementation of {@link org.xbib.rdf.io.sink.TripleSink} which serializes triples to {@link org.xbib.rdf.io.sink.CharSink} using
...
public final class TurtleSerializer implements TripleSink, RDF {
    ...
    private final Stack<String> bnodeStack = new Stack<String>();
