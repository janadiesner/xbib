...
public class CalendarParserImpl implements CalendarParser {
     ...
     * @throws java.io.IOException when unable to read from stream
     * @throws net.fortuna.ical4j.data.ParserException when next token in the stream does not match the expected token
     */
     ...
     * @param in
     * @return
     * @throws java.text.ParseException When reading EOF.
     */
