...
public class Parser {
   ...
   * @return
   */
  public List<DateGroup> parse(String value) throws IOException {
    
    // lex the input value to obtain our global token stream
    ANTLRInputStream input = new ANTLRNoCaseInputStream(new ByteArrayInputStream(value.trim().getBytes()));
